...
Depending on the build configuration and targeted framework, the assemblies will be located in the `bin/Debug<Core|Full>/<net50|net461>` or `bin/Release<Core|Full>/<net50|net461>` subdirectories
of the test project.
